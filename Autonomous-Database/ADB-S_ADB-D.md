...
### What is the difference between Dedicated vs. Serverless deployments?
...
### How can I learn more about Oracle Autonomous Database?
...
### Does Oracle Autonomous Database support per-second billing?
...
### Can auto-scaling help reduce my bills?
...
### What is the current availability SLA for Oracle Autonomous Database?
The SLA for ADB is 99.95% availability. Higher availability levels (99.995%) can be achieved with **Autonomous Data Guard**.

---

### Does Oracle Autonomous Database have a standby feature?
...
### What happens if Oracle Autonomous Database is down?
...
### Does ADB provide a web-based tool for end users?
...
### Does Oracle Autonomous Database support access to non-Oracle Databases?
...
### What types of data files are supported for loading?
- **Local Files**: AVRO, CSV, JSON, TSV, delimited TXT, XLS, XLSX, XML.
- **Cloud Storage**: AVRO, CSV, JSON, Parquet, ORC, delimited TXT.

---

### Does Oracle Autonomous Database support access to Data Lakes?
...
### Does ADB automatically create and manage indexes?
Yes, ADB can automatically create indexes, but auto-indexing is not enabled by default.

---

### Can ADB automatically manage partitioning strategies?
...
### How does Oracle Autonomous Database isolate customer workloads for performance?
...
### Does Autonomous Database offer a pre-migration check tool?
